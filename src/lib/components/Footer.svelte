...
<footer class="p-4 bg-white sm:p-6 dark:bg-gray-900">
  ...
  <div class="md:flex md:justify-between">
      <div class="mb-6 md:mb-0">
       <a href={premier} class="flex items-center"> 
              <img src= {logo} class="h-8 mr-3" alt="Premier Smartscape" />
              <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Premier Smartscape</span>
          </a>
      </div>
      <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          <div>
              ...
              <ul class="text-gray-600 dark:text-gray-400">
                  <li class="mb-4">
                      <a href= {premier} class="hover:underline">Services</a>
                  </li>
                  <li class="mb-4">
          ...
          <div>
              ...
              <!--add fb later    <li class="mb-4">  <a href={facebook} class="hover:underline ">Facebook</a> </li>--> 
                  <li>
  ...
  <div class="sm:flex sm:items-center sm:justify-between">
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href={premier} class="hover:underline">Premier Smartscape™</a>. All Rights Reserved.
      </span>
