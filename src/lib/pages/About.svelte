  ...
  let image2="https://luxurypools.com/wp-content/uploads/2018/05/Poolscape-with-three-separate-bistro-patio-areas_Rugged-Class-Waterfalls-Pools-488x325.jpg"
   ...
   <section class="pb-20 relative block bg-grey-900">
    ...
    >
      ...
      >
        <polygon
          class="text-gray-900 fill-gray-300"
            ...
            >
              <div class="px-4 py-5 flex-auto">
                ...
                ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                  <path d="M0 0v24h6v-24h-6zm4 22h-2v-2h1v-1h-1v-2h1v-1h-1v-2h1v-1h-1v-2h1v-1h-1v-2h1v-1h-1v-2h1v-1h-1v-2h2v20zm9-4.697l1.131 1.697h-1.131v-1.697zm-1-3.303v6h4l-4-6zm-4-14v24h16l-16-24zm2 20h1v-1h-1v-2h1v-1h-1v-2h1v-1h-1v-2h1v-1h-1v-3.026l10.392 15.026h-10.392v-2z"/></svg>
  ...
  c4.146,0,7.311,0.504,9.662,1.54c3.162,1.394,6.949,6.201,7.342,10.399C42.462,17.432,38.81,17.061,34.705,16.98z"/>
        ...
        <div class="flex flex-wrap items-center mt-32">
          <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
            ...
            >
            Whether we meet at your home or at our office conference center you can be confident that you’re dealing with a professional organization that can handle your construction project from design to completion.  Now is the time to act on your dream project. Please give us a call today for a free, no obligation consultation. 
            </p>
            <p
              class="text-lg font-bold leading-relaxed mt-0 mb-4 text-gray-700"
            >
            Premier Smartscape is here to serve you. We welcome all inquiries and look forward to hearing from you
            </p>
